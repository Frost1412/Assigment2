...
public class PCProg {
    ...
    public void createObjects() {
        ...
        System.out.print("Can you write down the model name: ");
        String model = sc.nextLine();

        System.out.print("Can you wirte down the year: ");
        int year = sc.nextInt();
        sc.nextLine();
        System.out.print("Can you wirte down the manufacturer: ");
        ...
        while (true) {
            System.out.print("Add components: ");
        ...
        if (!getObjects().isEmpty()) {
            for (PC object : getObjects().getElements()) {
                if (object.equals(pc)) {
